...
// Helper function to render content with @mentions and #hashtags as styled elements
...
// Convert CommentMedia[] to MediaItem[] for ImageViewer
function commentMediaToMediaItems(media: CommentMedia[]): MediaItem[] {
    return media.map(m => ({
...
export default function CommentSection({ postId, totalComments, onCommentCountChange, onChangeTotalComments }: CommentSectionProps) {
    ...
    const handleReplyClick = (commentId: string, parentId: string, userId: string, userName: string) => {
